...
import { AttendanceListComponent } from './features/attendances/attendance-list/attendance-list.component';
...
export const routes: Routes = [
  ...
  { path: 'attendances', component: AttendanceListComponent, canActivate: [authGuard] },
